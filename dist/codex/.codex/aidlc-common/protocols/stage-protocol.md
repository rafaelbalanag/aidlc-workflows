...
| **Bolt** | One execution of Construction stages 3.1–3.4 for a Unit (or small group of dependency-linked Units). Stages 3.5 (Build and Test) and 3.6 (CI Pipeline) run **once** after all Bolts complete, not per-Bolt. The first Bolt is the **walking skeleton** — the thinnest end-to-end slice that proves the architecture. |
