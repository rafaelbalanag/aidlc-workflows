...
//
// CLI-contract port of tests/feature/t120-classify-roundtrip.sh (TAP plan 19),
// mechanism = cli. The walking-skeleton classify round-trip: the ONE knowledge
// round-trip the v0.6.0 engine DEFERS rather than decides (vision §6,
// v06-vision.html:452-454; review Major A). The first Construction Bolt's gate
