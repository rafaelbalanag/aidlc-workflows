...
//
// CLI-contract port of tests/feature/t130-scope-runners.sh (TAP plan 12),
...
// routing the four first-batch scope runners (bugfix / feature / mvp /
// security-patch) drive through the engine. So this twin credits the four
...
// scope unitIds in tests/.coverage-registry.json: bugfix/feature/mvp/
// security-patch all enumerate from data/scope-grid.json.)
//
...
// not three independent greps; plan 12 = 4 scopes x 3 assertions):
