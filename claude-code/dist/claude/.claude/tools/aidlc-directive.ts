...
// The classify-round-trip sentinel (vision §6, v06-vision.html:452-454). Most
...
// The 8 kinds, in vision §6 catalogue order. Used both for the unknown-kind
...
if (import.meta.main) {
  // One well-formed example per kind. run-stage mirrors the vision §6 example
  // directive verbatim (application-design); the others follow the §6 table.
